          ...
          <div v-if="activeCategory === 'personalization'" class="space-y-6">
            <section class="space-y-3">
              ...
              <div class="grid grid-cols-2 gap-4">
                ...
                >
                  <div
                    class="aspect-[16/10] rounded-xl border-2 transition-all duration-300 p-3 bg-white shadow-sm overflow-hidden flex flex-col gap-1.5"
                    :class="
                  ...
                  >
                    ...
                    <div class="h-6 w-full bg-white border border-gray-100 rounded shadow-sm"></div>
                  ...
                  <div class="mt-2 flex items-center justify-between px-1">
                    <span class="font-medium text-[13px] text-[var(--td-text-color-primary)]">
                ...
                >
                  <div
                    class="aspect-[16/10] rounded-xl border-2 transition-all duration-300 p-3 bg-[#181818] shadow-sm overflow-hidden flex flex-col gap-1.5"
                    :class="
                      settings.theme === 'dark'
                        ? 'border-[var(--td-brand-color)] ring-2 ring-[var(--td-brand-color-light)]'
                  ...
                  >
                    <!-- 模拟界面 -->
                    <div class="h-2 w-1/3 bg-gray-800 rounded"></div>
                    <div
                      class="h-6 w-full bg-gray-800 border border-gray-700 rounded shadow-sm"
                    ></div>
                    <div class="flex gap-1.5 flex-1">
